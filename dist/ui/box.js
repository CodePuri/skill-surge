...
export function errorBox(title, body) {
...
export function dashboardBox(entries) {
    const maxLabel = Math.max(...entries.map(e => e.label.length));
    const lines = entries.map(e => `  ${gradient(['#00FFFF', '#00FFFF'])(e.label.padEnd(maxLabel))}  ${e.value}`);
